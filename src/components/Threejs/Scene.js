...
import classes from "../Threejs/Scene.module.css"
...
class Scene extends Component{
  ...
  setupScene(){
    ...
    this.skyBox();
    this.models = ['bird1', 'bird2', 'bird3', 'truck1'];
    this.addBirds();
    this.addTruck();
  ...
  addTruck(){
    this.modelLoader('tesla_cybertruck/scene.gltf', {x: -400, y: -100, z: -900}, this.models[3]);
  }
